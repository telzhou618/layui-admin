package org.alex.admin.web.test;
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		dsc.setUsername("root");
		dsc.setPassword("root");
		dsc.setUrl("jdbc:mysql://localhost:3306/alex-admin?characterEncoding=utf8");
		...
		strategy.setInclude(new String[] { "sys_user","tb_blog","sys_dept","sys_log","sys_menu","sys_role","sys_role_menu","sys_setting","sys_user_role" }); // 需要生成的表
		...
		pc.setParent("org.alex.admin");// 自定义包路径
