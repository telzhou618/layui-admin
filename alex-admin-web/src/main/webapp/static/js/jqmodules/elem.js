...
layui.define('jquery', function(exports) {
    ...
    Element.prototype.tabAdd = function(filter, options) {
        var TITLE = '.layui-tab-title',
            tabElem = options.parent ? $('.layui-tab[lay-filter=' + filter + ']', window.parent.document) : $('.layui-tab[lay-filter=' + filter + ']'),
    ...
    //外部Tab删除
    Element.prototype.tabDelete = function(filter, layid, parent) {
        var TITLE = '.layui-tab-title',
            tabElem = parent ? $('.layui-tab[lay-filter=' + filter + ']', window.parent.document) : $('.layui-tab[lay-filter=' + filter + ']'),
            titElem = tabElem.children(TITLE),
    ...
    //外部Tab切换
    Element.prototype.tabChange = function(filter, layid, parent) {
        var TITLE = '.layui-tab-title',
            tabElem = parent ? $('.layui-tab[lay-filter=' + filter + ']', window.parent.document) : $('.layui-tab[lay-filter=' + filter + ']'),
            titElem = tabElem.children(TITLE),
            liElem = titElem.find('>li[lay-id="' + layid + '"]');
